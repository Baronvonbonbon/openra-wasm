...
{
	/// <summary>
	/// The GL half of a graphics context, shared by every platform. Creating,
	/// binding, presenting and destroying the underlying context is platform
	/// specific and is left to the derived class.
	/// </summary>
	abstract class GraphicsContext : ThreadAffine, IGraphicsContext
	{
		public string GLVersion => OpenGL.Version;

		/// <summary>
		/// Binds the context to the calling thread and assigns
		/// <see cref="OpenGL.GetProcAddress"/> and <see cref="OpenGL.IsExtensionSupported"/>.
		/// </summary>
		protected abstract void MakeContextCurrent();

		/// <summary>The window this context draws into, for scissor rectangle scaling.</summary>
		protected abstract IPlatformWindow Window { get; }

		public abstract void Present();

		public abstract void SetVSyncEnabled(bool enabled);

		/// <summary>Releases the underlying platform context.</summary>
